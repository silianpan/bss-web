      ...
      <Row type="flex" :gutter="8">
        <i-col :xs="24" :sm="6" :md="6" :lg="6">
          <FormItem :label="`区县`" style="width:100%;">
            <AreaSelect :pid="areaInfo.id" v-model="formDatas.area" placeholder="区县" @on-change="handleAreaChange"></AreaSelect>
          </FormItem>
        </i-col>
        <i-col :xs="24" :sm="6" :md="6" :lg="6">
        ...
        <i-col :xs="24" :sm="8" :md="7" :lg="7">
          <FormItem label="对比年度" style="width:100%;">
            <BudgetDeptFinalYearSelect v-model="formDatas.startYear" :default-value-index="1" placeholder="开始年" :conditions="yearQueryConditions"></BudgetDeptFinalYearSelect>
            <BudgetDeptFinalYearSelect v-model="formDatas.endYear" placeholder="结束年" :conditions="yearQueryConditions"></BudgetDeptFinalYearSelect>
          </FormItem>
        </i-col>
