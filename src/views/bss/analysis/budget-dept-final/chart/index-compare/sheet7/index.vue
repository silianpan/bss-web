...
<script>
import Sheet7Detail from '@/views/bss/analysis/budget-dept-final/detail-info/sheet7-detail'
...
export default {
  ...
  data() {
    return {
      ...
      options2: {
        title: '政府性基金预算财政拨款收入支出决算-年初结转和结余（万元）',
        chartProps: {
          padding: [10, 130, 100, 80]
        },
        legendProps: {
      ...
      options3: {
        title: '政府性基金预算财政拨款收入支出决算-本年收入（万元）',
        chartProps: {
          padding: [10, 130, 100, 80]
        },
        legendProps: {
      ...
      options4: {
        title: '政府性基金预算财政拨款收入支出决算-本年支出（万元）',
        chartProps: {
          padding: [10, 130, 100, 80]
        },
        legendProps: {
      ...
      options5: {
        title: '政府性基金预算财政拨款收入支出决算-年末结转和结余（万元）',
        chartProps: {
          padding: [10, 130, 100, 80]
        },
        legendProps: {
  ...
  methods: {
    ...
    handleClick(qp, flag) {
      ...
      let drawer = this.$dynamicDrawer.newInstance(
        {
          title: `${govDept}-政府性基金预算财政拨款收入支出详情`,
          width: 80,
          render: h => {
            return <Sheet7Detail queryParams={qp} flag={flag}></Sheet7Detail>
          }
        },
        this
      )
