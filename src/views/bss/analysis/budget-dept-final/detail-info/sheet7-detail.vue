...
<script>
import Api from '@/api/sys/analysis/budget-dept-final-s7'
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    title: '小计',
                    key: 'budgetEndProject',
                    align: 'center'
                  },
                  {
                    title: '基本建设',
                    key: 'budgetEndProjectCons',
                    align: 'center'
                  }
                ]
              }
