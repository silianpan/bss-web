...
import BudgetDeptFinalSheet1 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet1'
import BudgetDeptFinalSheet2 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet2'
import BudgetDeptFinalSheet3 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet3'
import BudgetDeptFinalSheet4 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet4'
import BudgetDeptFinalSheet5 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet5'
import BudgetDeptFinalSheet6 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet6'
import BudgetDeptFinalSheet7 from '@/views/bss/analysis/budget-dept-final/chart/year-compare/sheet7'
export default {
  props: {
    areaInfo: {
      type: Object,
