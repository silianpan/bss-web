<template>
  <div style="height:100%;">
    ...
    <div style="padding:16px;height: 100%; overflow-y: auto;">
      ...
      <div>
        <component :qc="qc" :conditions="conditions" :is="currentComp" :groupField="'govDept'"></component>
      </div>
    </div>
...
import BudgetDeptSheet1 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet1'
import BudgetDeptSheet2 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet2'
import BudgetDeptSheet3 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet3'
import BudgetDeptSheet4 from '@/views/bss/analysis/budget-dept/chart/dept-compare/sheet4'
import BudgetDeptSheet5 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet5'
import BudgetDeptSheet6 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet6'
import BudgetDeptSheet7 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet7'
import BudgetDeptSheet8 from '@/views/bss/analysis/budget-dept/chart/year-compare/sheet8'
export default {
  props: {
    areaInfo: {
      type: Object,
  ...
  methods: {
    ...
    handleAnalysis() {
      ...
      if (!formDatas.govDept1 || this.$_.isEmpty(formDatas.govDept1) || !formDatas.govDept2 || this.$_.isEmpty(formDatas.govDept2)) {
        this.$Message.warning('请选择部门进行分析!')
        return
      }
      formDatas.govDepts = [formDatas.govDept1, formDatas.govDept2]
      this.qc = formDatas
      this.conditions = this.$refs.conditions.getConditions()
      this.conditions.push({ field: 'govDepts', value: [formDatas.govDept1, formDatas.govDept2] })
