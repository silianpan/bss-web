<!-- 非税收入：条形图 -->
<template>
  <Column :options="options" :queryFunc="queryFunc" :queryParams="queryParams" ref="barRef" @column-title-click="handleTitleClick" @column-label-click="handleClick" />
</template>
